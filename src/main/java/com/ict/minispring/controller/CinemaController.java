...
public class CinemaController {
	...
	@ResponseBody
	public String upload(@RequestParam("c_idx") int c_idx, @RequestParam("cinema") MultipartFile c_photo) throws Exception{
	...
	/**@ResponseBody 로 
	 * 반환값을 CinemaVo 객체로 반환하면 자동으로 json 형태로 반환처리됨 (** 스프링의 특징) 
	 * 
	 * {"c_idx":21,"c_category":"액션","c_subject":"제목","c_info":"내용",
	 * "c_filename":"1671036698747_align-fingers-71282_640.jpg","c_regdate":"2022-12-15 01:51:38"}
	 * 영화상세보기
	 * @param c_idx
	 * @return
	 */
