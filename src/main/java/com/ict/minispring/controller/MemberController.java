...
public class MemberController {
	...
	@ResponseBody
	public boolean checkNickname(String m_nickname) throws Exception {		
	...
	@ResponseBody
	public int check_name(String m_name) throws Exception {
		return member_dao.checkMemberName(m_name);
	}
