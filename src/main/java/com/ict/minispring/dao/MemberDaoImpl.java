...
public class MemberDaoImpl implements MemberDao {
	...
	@Override
	public int checkMemberName(String m_name)  throws Exception{
		return sqlSession.selectOne("member.checkMemberName", m_name);		
	}

	@Override
	public MemberVo checkNickname(String m_nickname) throws Exception {
