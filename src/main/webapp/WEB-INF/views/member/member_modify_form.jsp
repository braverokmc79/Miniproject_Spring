  ...
  $(document).ready(function(){
	  ...
	  $("#m_name").keyup(function(event){
		  ...
		  if(regular_name.test(m_name)==false){
			  ...
			  $("#name_msg").html("이름은 한글 또는 영문으로 입력해주세요")
			              .css("color","red");
	  ...
	  $(document).ready(function(){
		  ...
		  $("#m_pwd").keyup(function(event){
			  ...
			  if(regular_pwd.test(m_pwd)==false){
				  ...
				  $("#pwd_msg").html("8자 이상의 영문자, 숫자, 특수문자 조합으로 입력해주세요")
				              .css("color","red");
			  ...
			  //서버에 사용가능 여부 확인(jQuery Ajax)
			  $.ajax({
				  url		: 'check_pwd.do',			//MemberCheckIdAction
  ...
  $(document).ready(function(){
	  ...
	  $("#m_nickname").keyup(function(event){
		  ...
		  if(regular_nickname.test(m_nickname)==false){
			  ...
			  $("#nickname_msg").html("닉네임은 3~16자리의 한글 또는 영문으로 입력해주세요")
			              .css("color","red");
		  ...
		  $.ajax({
			  ...
			  data		: {'m_nickname': m_nickname},			//parameter : check_nickname.do?m_nickname=one
			  dataType	: 'json',
			  success	: function(res_data){
				  //res_data = {"result": true }  //사용가능
				  //res_data = {"result": false}  //사용중(사용못함)
...
<%-- RootContext경로 : ${ pageContext.request.contextPath }  <br> --%>
        ...
        <div class="panel panel-primary">
	      ...
	      <div class="panel-body">
	          <table class="table  table-striped">
	             ...
	             <tr>
	                <th>이름</th>	                
	                <td><input name="m_name" value="${ vo.m_name }"  class="form-control" id="m_name" >
	             ...
	             <tr>
	                <th>아이디</th>
	                <td>
	                   <input name="m_id"  value="${ vo.m_id }" id="m_id" class="form-control"  readonly="readonly" >
	                   <span id="id_msg"></span>
	                </td>
	             </tr>
	              ...
	              <tr>
	                <th>비밀번호</th>
	                <td><input type="password" name="m_pwd"  class="form-control" value="${ vo.m_pwd }">
	             ...
	             <tr>
	                <th>닉네임</th>
	                <td><input name="m_nickname" value="${vo.m_nickname }" class="form-control" id="m_nickname">
	             ...
	             <tr>
	                ...
	                <td>
	                   ...
	                   value="${vo.m_zipcode }" style="display: inline;width: 30%" readonly>
	                   <input type="button"  value="주소찾기" class="btn btn-default"  onclick="find();" >     
	                </td>
	             </tr>
	             
	             <tr>
	                <th>주소</th>
	                <td><input id="m_addr" name="m_addr"  class="form-control" value="${ vo.m_addr }" size="60"></td>
	             </tr>
	             ...
	             <tr>
	             	<th>회원등급</th>
	             	<td>
	             	  <select id="m_grade" name="m_grade" class="form-control">
	             ...
	             <tr>
	                <td colspan="2" align="center">
	                	<input type="hidden" name="m_idx" value="${ vo.m_idx }" id="m_idx">
	                     <input class="btn  btn-primary submit"  type="button"  value="정보수정" id="btn_register" 
	                     disabled="disabled" 
	                            onclick="send(this.form);" onkeyup="if(window.event.keyCode==13){enterup()}">
	                     <input class="btn  btn-success"  type="button"  value="목록으로"
	                            onclick="location.href='${ pageContext.request.contextPath }/member/list.do';">
	                </td>
	             </tr>
